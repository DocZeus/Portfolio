		...
		<LazyMotion features={domAnimation}>
			<section id="about" className="section">
				...
				<div
					tabIndex={0}
					ref={ref}
					className="pt-10 pb-16 max-w-5xl flex flex-col gap-3 text-xl font-light leading-relaxed"
					style={{
				...
				>
					<p>
						My name is Swapnil. I successfully graduated BMS Institute of Technology and Management, Information Science Engineering.
					</p>
					<p>
					...
					<p>
						One day, I decided to try something new, and I started learning React. I was so excited
						to see how fast I can build a website with it, and how easy it is to maintain it.
						{/* Consequently, I quickly learnt Next.js and I used it to build some company projects
						working in a team with a backend dev. */}
					</p>
					{/* <p className="my-3.5">
